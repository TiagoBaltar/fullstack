...
describe('favorite blog', () => {
  ...
  test('of single blog list is itself', () => {
    const res = {
      title: 'Go To Statement Considered Harmful',
      author: 'Edsger W. Dijkstra',
      likes: 5,
    }
    expect(favoriteBlog(listWithOneBlog)).toEqual(res)
  })
  ...
  test('of a list of blogs is fecthed correctly', () => {
    ...
    expect(favoriteBlog(blogs)).toEqual(res)
  })
})
...
describe('most blogs', () => {
  ...
  test('of a list of blogs is fecthed correctly', () => {
    ...
    expect(mostBlogs(blogs)).toEqual(res)
  })
})
...
describe('most likes', () => {
  ...
  test.only('of a list of blogs is fecthed correctly', () => {
    ...
    expect(mostLikes(blogs)).toEqual(res)
  })
})
